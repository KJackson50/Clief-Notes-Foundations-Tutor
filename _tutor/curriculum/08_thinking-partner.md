# Lesson 8 — ChatGPT as Thinking Partner
...
You will stop using ChatGPT like a vending machine and start using it as a thinking partner. You will work through a real problem, find an insight you did not have before, and understand when to think in ChatGPT and when to build in Codex.
...
Most people use ChatGPT like a vending machine. Question in, answer out. "Write me a marketing plan." ChatGPT gives you a document. You paste it somewhere. Done.

That works for simple tasks. But it wastes the most powerful thing ChatGPT can do: think with you.
...
ChatGPT (the conversational interface) is the best tool for:
...
None of these require ChatGPT to touch your files. They require ChatGPT to think alongside you. The chat interface is built for exactly this.
...
Without planning: You open Codex and start building. Halfway through you realize you are not sure what you actually want. You restart. You try a different approach. You restart again. Three restarts. Two hours.

With planning: You open ChatGPT and spend 15 minutes thinking through the problem. What are you building? Who is it for? What does success look like? What are the trade-offs? You get clear. Then you open Codex and build it. One build. 30 minutes.

The 15 minutes of thinking saves 90 minutes of building the wrong thing. ChatGPT for decisions. Codex for execution.



ChatGPT Projects

ChatGPT has a feature called Projects. You can give a Project your key documents, preferences, or background material. Every conversation you start inside that Project has that context already loaded.
...
Think of Projects as the seed for what comes next in Session 4. They give ChatGPT background. Session 4 (AGENTS.md) gives ChatGPT deep project understanding.



Tips

ChatGPT for decisions. Codex for execution. If you are deciding what to build, use ChatGPT. If you are building it, use Codex. If you try to decide and build at the same time, both suffer.

Start with what you are trying to accomplish, not what you want ChatGPT to produce. "I need a marketing plan" is a product request. "I am trying to get 50 signups for a workshop in two weeks with no ad budget" is a problem. ChatGPT is a better thinking partner when it knows the problem.
...
Conversations are disposable. The thinking is not. Do not treat a ChatGPT conversation like a document to save. Treat it like a whiteboard session. The value is the insight you walk away with, not the transcript.
...
Run this in ChatGPT (or right here). Come back with: what was the key insight or question you didn't have before?"
...
2. Ask: "You've now used ChatGPT for thinking and Codex for execution. What's a situation in your work where you'd reach for the thinking-partner prompt first, before opening Codex?"

3. Record in `_tutor/progress.md`:
   - lesson: "08_thinking-partner"
   - artifacts_inspected: ["[path]/prompts/thinking-partner.md"]
   - comprehension.question: "What's a situation in your work where you'd reach for the thinking-partner prompt first, before opening Codex?"
